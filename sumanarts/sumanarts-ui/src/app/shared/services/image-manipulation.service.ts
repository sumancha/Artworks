...
import { DataTransformerService } from '../utils/date-parser';
...
export class ImageManipulationService {
  ...
  AddArt(data: any): Observable<ArtImage> {
    ...
    formData.append(
      'createdDate',
      data.createdDate
        ? DataTransformerService.parseDatetoISO(data.createdDate)
        : '',
    );
    formData.append(
      'soldDate',
      data.soldDate ? DataTransformerService.parseDatetoISO(data.soldDate) : '',
    );
